        ...
        tariq = $('.content_managment_table').DataTable({
            ...
            buttons: [{
                ...
                action: function(e, dt, node, config) {
                    datatableSelectedRowsAction(dt, 'client/action', action = 'delete', msg = 'Once deleted, it will deleted all related Data!');
                }
            }, {
                extend: 'selected',
                ...
                text: 'Online',
                action: function(e, dt, node, config) {
                    datatableSelectedRowsAction(dt, 'client/action', action = 'online', msg = 'Change Status To Online');
                }
            },{
                extend: 'selected',
                ...
                text: 'Offline',
                action: function(e, dt, node, config) {
                    datatableSelectedRowsAction(dt, 'client/action', action = 'offline', msg = 'Change Status To Offline');
                }
            },{
                extend: 'selected',
