        ...
        tariq = $('.content_managment_table').DataTable({
            ...
            buttons: [{
                ...
                action: function(e, dt, node, config) {
                    datatableSelectedRowsAction(dt, 'configuration/master/case_stage/action', action = 'delete', msg = 'Once deleted, it will deleted all related Data!');
                }
            },{
                extend: 'selected',
                ...
                text: 'Online',
                action: function(e, dt, node, config) {
                    datatableSelectedRowsAction(dt, 'configuration/master/case_stage/action', action = 'online', msg = 'Change Status To Online');
                }
            }, {
                extend: 'selected',
                ...
                text: 'Offline',
                action: function(e, dt, node, config) {
                    datatableSelectedRowsAction(dt, 'configuration/master/case_stage/action', action = 'offline', msg = 'Change Status To Offline');
                }
            }, {
                extend: 'selected',
                ...
                text: 'Toggle Status',
                action: function(e, dt, node, config) {
                    datatableSelectedRowsAction(dt, 'configuration/master/case_stage/action', action = 'toggle', msg = 'Toggle Status');
                }
            }],
            select: true,
            columnDefs: [{
