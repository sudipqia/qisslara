        ...
        tariq = $('.content_managment_table').DataTable({
            ...
            buttons: [{
                ...
                action: function(e, dt, node, config) {
                    datatableSelectedRowsAction(dt, 'configuration/master/union/action', action = 'delete', msg = 'Once deleted, it will deleted all related Data!');
                }
            }],
            select: true,
            columnDefs: [{
