    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                ...
                {{ Form::hidden('target', 'client_category', ['id' => 'target']) }}
                {{ Form::hidden('status', 1) }}
                {{ Form::text('name',  isset($data['name']) ? $data['name'] : Null, ['class' => 'form-control', 'placeholder' =>  _lang('client_category'), 'required' => '']) }}
            </div>
        </div>
    </div>
    <div class="row">
