@php
$route = 'admin.configuration.master.case_stage.';
$js = ['configuration/master/case_stage'];
@endphp
{{-- Available Modal Size = xs, sm, lg, full --}}
@extends('layouts.app', ['title' => _lang('case_stage_configuration'), 'modal' => 'lg'])
@section('page.header')
	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		<div class="d-flex">
			<div class="breadcrumb">
				...
				<span class="breadcrumb-item active">{{ _lang('case_stage_configuration') }}</span>
			</div>
...
<div class="card border-top-success rounded-top-0" id="table_card">
	<div class="card-header header-elements-inline bg-light border-grey-300" >
		<h5 class="card-title">{{ _lang('case_stage_configuration') }}
@can('case_satge.create')
		<button type="button" class="btn btn-outline alpha-info text-info-800 border-info-600 rounded-round" id="content_managment" data-url="{{route($route.'create')}}"><i class="icon-stack-plus mr-1"></i> {{ _lang('add_new_case_stage') }}</button>
		@endcan
		</h5>
