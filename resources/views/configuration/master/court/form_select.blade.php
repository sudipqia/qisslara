    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                ...
                {{ Form::text('name',  isset($data['name']) ? $data['name'] : Null, ['class' => 'form-control', 'placeholder' =>  _lang('court'), 'required' => '']) }}
            </div>
        </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-12">
            <div class="form-group">
                ...
                {{ Form::hidden('court_category[id]', isset($data['court_category']) ? $data['court_category'] : ''), ['data-parsley-errors-container' => '#category_error_area'] }}
                {{ Form::select('court_category[id]',$categories,isset($data['court_category']) ? $data['court_category'] : '', ['class' => 'form-control select', 'data-placeholder' =>  _lang('court_category'), 'required' => '', 'id' => 'court_category', 'disabled' => '']) }}
