@php
    ...
    $js = ['bank'];
@endphp
@extends('layouts.app', ['title' => _lang('Solution Card'), 'modal' => 'lg'])
@section('page.header')
	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		<div class="d-flex">
			<div class="breadcrumb">
				...
				<span class="breadcrumb-item active">{{ _lang('Solution Card') }}</span>
			</div>
...
<div class="card border-top-success rounded-top-0" id="table_card">
	<div class="card-header header-elements-inline bg-light border-grey-300" >
		<h5 class="card-title">{{ _lang('Solution Card') }}
		    
		</h5>
		<div class="header-elements">
			<button type="button" class="btn btn-outline alpha-info text-info-800 border-info-600 rounded-round" id="content_managment" data-url="{{ route($route.'create') }}"><i class="icon-stack-plus mr-1"></i> {{ _lang(' New Solution Card') }}</button>
		</div>
	</div>
	<div class="card-body">
		<div class="row">
                ...
                <table class="table table-bordered content_managment_table" data-url="{{ route($route.'datatable') }}">
                    <thead>
                        <tr>
                            <th>{{ _lang('id') }}</th>
                            <th>{{ _lang('Header') }}</th>
                            <th>{{ _lang('Sub Header') }}</th>
                            <th>{{ _lang('In new Tab') }}</th>
