@php
    ...
    $js = ['bank'];
@endphp
@extends('layouts.app', ['title' => _lang('Create Testimonial')])
@section('page.header')
	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		<div class="d-flex">
			<div class="breadcrumb">
				...
				<a href="{{ route( $route . 'index') }}"  class="breadcrumb-item active">{{ _lang('testimonial') }}</a>
...
<div class="card border-top-success rounded-top-0" id="table_card">
	<div class="card-header header-elements-inline bg-light border-grey-300" >
		<h5 class="card-title">{{ _lang('Create new testimonial') }}
	...
	<div class="card-body">
		<form class="form-validate-jquery" id="content_form" action="{{ route('admin.testimonial.store') }}" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-6 form-group">
                    <label for="rating">Rating <span class="text-danger">*</span></label>
                    <input type="file" name="rating" required id="rating" class="form-control dropify">
                ...
                <div class="col-md-12 form-group">
                    ...
                    <textarea name="video_url" id="video_url" cols="30" rows="3" class="form-control"></textarea>
                </div>
