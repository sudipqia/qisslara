		...
		<form class="form-validate-jquery" id="content_form"  action="{{ route($route . 'store') }}" method="POST" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-12 form-group">
                    ...
                    <textarea name="meta_article_tag" id="meta_article_tag" cols="30" rows="4" class="form-control" placeholder="Enter Article Tag"></textarea>
                </div>
                
                <div class="col-md-12 form-group">
                    <label for="meta_script">Script Tag </label>
                    <textarea name="meta_script" id="meta_script" cols="30" rows="4" class="form-control" placeholder="Enter Article Tag"></textarea>
                </div>
