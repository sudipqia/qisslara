@php
    ...
    $js = ['bank'];
@endphp
@extends('layouts.app', ['title' => _lang('Case Study'), 'modal' => ''])
@section('page.header')
	...
	<div class="card-header header-elements-inline bg-light border-grey-300" >
		...
		<div class="header-elements">
            <a href="{{ route($route.'create') }}">
			    <button type="button" class="btn btn-outline alpha-info text-info-800 border-info-600 rounded-round"><i class="icon-stack-plus mr-1"></i> {{ _lang('Create News') }}</button>
            </a>
		</div>
	</div>
	<div class="card-body">
