...
<fieldset class="mb-3">
    ...
    <form class="form-validate-jquery" id="content_form" action="{{ route('admin.service-sub-category.index') }}" method="POST">
        <div class="row">

            <div class="col-md-12 form-group">
                <label for="category_id">Category <span class="text-danger">*</span></label>
                <select name="category_id" id="category_id" class="form-control select" required data-placeholder="Select Category">
