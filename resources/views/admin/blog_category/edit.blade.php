...
<fieldset class="mb-3">
    ...
    <form class="form-validate-jquery" id="content_form" action="{{ route('admin.blog-category.update', $model->id) }}" method="POST">
        @csrf
        @method('PATCH')
        <div class="row">
            ...
            <div class="col-md-6 form-group">
                ...
                <input type="text" name="slug" id="slug" class="form-control" placeholder="Enter Category Slug" required value="{{ $model->slug }}">
            </div>
