...
<fieldset class="mb-3">
    ...
    <form class="form-validate-jquery" id="content_form" action="{{ route('admin.blog-tag.update', $model->id) }}" method="POST">
        @csrf
        @method('PATCH')
        <div class="row">
            <div class="col-md-12 form-group">
                <img src="{{ asset('storage/blog/tag/'. $model->bg_photo) }}" alt="Background Photo" style="width:250px;">
            ...
            <div class="col-md-6 form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" placeholder="Enter Tag Name" required value="{{ $model->name }}">
            </div>

            <div class="col-md-6 form-group">
                <label for="slug">Slug <span class="text-danger">*</span></label>
                <input type="text" name="slug" id="slug" class="form-control" placeholder="Enter Tag Slug" required value="{{ $model->slug }}">
            </div>
            ...
            <div class="col-md-6 form-group">
                ...
                <select name="is_archived" id="is_archived" class="form-control select" data-placeholder="Select One" required>
                    <option value="">Select One</option>
                    <option {{ $model->is_archived == 1 ? 'selected' : '' }} value="1">Yes</option>
                    <option {{ $model->is_archived == 0 ? 'selected' : '' }} value="0">No</option>
                </select>
            </div>
