...
<div class="qia-inner-blog pt-120 pb-120 md-pt-90 md-pb-90">
    <div class="container">
        <div class="row">
            ...
            <!--                    <div class="post-img">-->
            <!--                        <a href="{{ URL::to($blog->slug) }}"><img src="{{ asset('storage/news/'. $blog->cover_photo) }}" alt="{{ $blog->cover_photo_alter_tag }}"></a>-->
            <!--                    </div>-->
            <!--                    <div class="post-desc">-->
                            ...
                            <div class="blog-item row">
                                <div class="blog-img p-0 col-md-6">
                                    <a href="{{ URL::to($blog->slug) }}">
                                        <img style="width:520px;height:275px;" src="{{ asset('storage/news/'. $blog->cover_photo) }}" alt="{{ $blog->cover_photo_alter_tag }}">
                                    </a>
                                </div>
