...
@section('content')
<div class="qia-breadcrumbs img4" style="background-image: url({{ asset('storage/blog/category/'. $blogCategory->bg_photo) }})" >
    <div class="breadcrumbs-inner text-center" style="padding: 50px 0px;">
        <h1 class="page-title new-title pb-10">{{ $blogCategory->name }}</h1>
        <ul>
            <li title="QIA">
